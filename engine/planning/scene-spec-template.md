...
```json
{
  ...
  "beat_jobs": ["GENERATED JOB 1", "GENERATED JOB 2"],
  "branch_depth": 0,
  "claimant_focus_ids": [],
  "threshold_figure": "1-2-2-3",
  ...
  "hesitation_consequence": null,
  "prose_mdx": "COMPLETE GENERATED READER-FACING PROSE"
}
```

Every scene must perform at least two real dramatic jobs and change interpretation,
